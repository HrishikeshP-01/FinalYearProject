...
class MapEditor(QtWidgets.QMainWindow):
    def __init__(self, fn):
        ...
        self.ui.hmButton.clicked.connect(self.hmEvent)
        self.ui.modelButton.clicked.connect(self.modelEvent)
    ...
    def read(self, fn):
        ...
        try:
            ...
            self.resolution=0.05000
            self.origin.x=-10.000
            self.origin.y=-10.000
        except:
    ...
    def hmEvent(self,event):
        self.im_invert=ImageOps.invert(self.im)
        self.im_invert.save("HeightMap.png")

    def modelEvent(self,event):
        converter.imageProcessing("heightMap.png","ResultingModel")
