...
class Ui_MapEditor(object):
    def setupUi(self, MapEditor):
        ...
        self.hmButton = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy=QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.saveButton.sizePolicy().hasHeightForWidth())
        self.hmButton.setSizePolicy(sizePolicy)
        self.hmButton.setObjectName("hmButton")
        self.horizontalLayout.addWidget(self.hmButton)
        ...
        self.horizontalLayout.addWidget(self.modelButton)
    ...
    def retranslateUi(self, MapEditor):
        ...
        self.hmButton.setText(_translate("MapEditor","Generate Height Map"))
        self.modelButton.setText(_translate("MapEditor","Generate 3D Model"))
